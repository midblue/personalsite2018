module.exports = [
  {
    p: [
      `<a href="https://discord.com/api/oauth2/authorize?client_id=437598259330940939&permissions=68672&scope=bot" target="_blank">Add TimezoneBot to your Discord server now!</a>`,
  ...
  },
  {
    ol: [
      ...
      `The recipient has not sent a message in the last hour`,
  ...
  },
  {
    p: [
      ...
      `You can add TimezoneBot to your server by clicking <a href="https://discord.com/api/oauth2/authorize?client_id=437598259330940939&permissions=68672&scope=bot" target="_blank">this link</a>, and the source of this project is publicly available <a href="https://github.com/midblue/timezone-bot" target="_blank">here</a>. Feel free to take a look, or even spin up a copy for your own Discord channel! Thanks for reading!`,
    ],
  },
];
